...
function ParseConfig() {
     ...
     var catname = "Firebase";
     category[catname] = new Object(); 
     category[catname]["enabled"] = false;
     category[catname]["found"] = false;
     param[catname] = new Object();
     ParamAddValue(param, catname, "Email");
     ParamAddValue(param, catname, "Password", 1, false);
     ...
     category[catname]["found"] = false;
     param[catname] = new Object();
     ParamAddValue(param, catname, "IO0", 4, false, [null, null, /^[0-9]*$/]);
     ParamAddValue(param, catname, "IO1", 4, false, [null, null, /^[0-9]*$/, null]);
     ParamAddValue(param, catname, "IO3", 4, false, [null, null, /^[0-9]*$/, null]);
     ParamAddValue(param, catname, "IO4", 4, false, [null, null, /^[0-9]*$/, null]);
     ParamAddValue(param, catname, "IO12", 4, false, [null, null, /^[0-9]*$/, null]);
     ParamAddValue(param, catname, "IO13", 4, false, [null, null, /^[0-9]*$/, null]);
