...
void unregister_server_camera_uri(httpd_handle_t server)
{
#ifdef DEBUG_DETAIL_ON   
    ESP_LOGI(TAGPARTCAMERA, "server_part_camera - Unregistering URI handlers");
#endif  
    httpd_unregister_uri_handler(server, "/lighton", HTTP_GET);
    httpd_unregister_uri_handler(server, "/lightoff", HTTP_GET);
    httpd_unregister_uri_handler(server, "/capture", HTTP_GET);
    httpd_unregister_uri_handler(server, "/capture_with_flashlight", HTTP_GET); 
    httpd_unregister_uri_handler(server, "/save", HTTP_GET);    
}
