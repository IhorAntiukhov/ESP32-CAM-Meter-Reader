...
///////////////////////////////
    ...
    httpd_resp_sendstr_chunk(req,
        ...
        "<thead><tr><th style=\"font-size: 18px; font-weight: bold; font-family: monospace; color: #7F8C37;\">Название</th><th style=\"font-size: 18px; font-weight: bold; font-family: monospace; color: #7F8C37;\">Тип</th><th style=\"font-size: 18px; font-weight: bold; font-family: monospace; color: #7F8C37;\">Размер (Байты)</th>");
    if (!readonly) {
        httpd_resp_sendstr_chunk(req, "<th style=\"font-size: 18px; font-weight: bold; font-family: monospace; color: #7F8C37;\">Удаление<br>"
    ...
    while ((entry = readdir(dir)) != NULL) {
        if (strcmp("wlan.ini", entry->d_name) != 0 )        // wlan.ini soll nicht angezeigt werden!
        {
            ...
            httpd_resp_sendstr_chunk(req, "<tr style=\"font-size: 18px; font-weight: bold; font-family: monospace; color: #7F8C37;\"><td style=\"font-size: 18px; font-weight: bold; font-family: monospace; color: #7F8C37;\"><a style=\"font-size: 18px; font-weight: bold; font-family: monospace; color: #7F8C37;\" href=\"");
