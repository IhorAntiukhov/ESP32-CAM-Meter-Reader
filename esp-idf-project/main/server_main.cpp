...
std::string firstP = "<p style=\"font-size: 18px; font-weight: bold; font-family: monospace; color: #7F8C37;\">";
std::string secondP = "</p>";
...
esp_err_t info_get_handler(httpd_req_t *req)
{
    ...
    {
        std::string zw = firstP;
        zw = zw + std::string(getHTMLversion());
        zw = zw + secondP;
    ...
    {
        std::string zw = firstP;
        zw = zw + std::string(libfive_git_version());
        zw = zw + secondP;
        httpd_resp_sendstr_chunk(req, zw.c_str());
        httpd_resp_sendstr_chunk(req, NULL);  
        return ESP_OK;        
    ...
    {
        std::string zw = firstP;
        zw = zw + std::string(git_base_branch());
        zw = zw + secondP;
        httpd_resp_sendstr_chunk(req, zw.c_str());
        httpd_resp_sendstr_chunk(req, NULL);  
        return ESP_OK;        
